...
void loop() {
	...
	/// trace to see smoothed values from accel
      ...
      boolean isStab; 
	  	...
	  	if ( ((x >= 230 && x <= 260) && (y >= 205 && y <= 235) && (z >= 240 && z <= 255)) && (accelDifference > STAB_THRESHOLD)) {  
        ...
        Serial.print(stringToPrint);
	  	...
	  	}else if ( ((x >= 116 && x <= 160) && (y >= 210 && y <= 240) && (z >= 120 && z<= 160)) && (accelDifference > SPIN_THRESHOLD) ) {
        ...
        Serial.print(stringToPrint);
	  	...
	  	}else if ( ((x >= 280 && x <= 310) && (y >= 270 && x <= 300) && (z >= 220 && z <= 250)) && (accelDifference > SLASH_THRESHOLD) ) {
        ...
        Serial.print(stringToPrint);
  		...
  		}else if ( ((x >= 180 && x <= 240) && (y >= 160 && x <= 220) && (z >= 220 && z <= 240)) && (accelDifference > SLASH_THRESHOLD) ) {

        /// Alternate Slash (for when the bean is upside down... stillll pokey but good enough for now)
